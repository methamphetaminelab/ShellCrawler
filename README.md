...
- Как будет выглядеть подземелье?
  ...
  - Количество врагов высчитывается по формуле: [количество_врагов] = [количество_сундуков] | шанс спавна: 1/5
  - Количество сундуков высчитывается по формуле: [количество_сундуков] = [длина_комнаты] \* [ширина_комнаты] // 3 | шанс спавна: 1/5
...
_ПЛАНИРУЕТСЯ ЧТО-ТО ПОХОЖЕЕ НА БОЕВКУ ИЗ UNDERTALE_
