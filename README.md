...
1. Создание алгоритма для генерации комнат в подземелье
2. Создание алгоритма для генерации сундуков в комнатах
3. Создание алгоритма для генерации врагов
4. Реализация управления игроком в подземелье
5. Реализация создания входа и выхода в подземелье
6. Реализация боя в подземелье (смерть игрока, убийство врага)
7. Реализация использования карманов и предметов в подземелье
8. Реализация всех меню и оставшиеся механики
