...
- Как будет выглядеть подземелье?
  ...
  - Урон врага высчитывается по формуле: урон = базовый*урон*врага + уровень*персонажа + сложность*подземелья
  - Броня врага высчитывается по формуле: броня = базовый*урон*врага + уровень*персонажа + сложность*подземелья
  - Каждое подземелье имеет шанс заспавнить босса
  - Шанс спавна босса высчитывается по формуле: шанс = уровень*персонажа \* сложность*подземелья \ 100
